        ...
        <div class="container home-flow">
                ...
                <div class="grid grid-4 course-showcase">
                        ...
                        <div class="card-body">
                            ...
                            <div class="course-actions">
                                <a class="btn btn-soft" href="#admission-form-section"
                                    data-course-select="quran"><svg class="icon" aria-hidden="true">
                                        <use href="/assets/frontend/images/icons-sprite.svg#icon-clipboard-check">
                                        </use>
                                    </svg><span>ভর্তি আবেদন করুন</span></a>
                                <button class="btn btn-gold" type="button"
                                    data-demo="কুরআন তিলাওয়াত ও তাজবিদ কোর্সের পেমেন্ট ডেমো চালু হয়েছে।"><svg
                    ...
                    <article class="card course-card-premium">
                        ...
                        <div class="card-body">
                            ...
                            <div class="course-actions">
                                <a class="btn btn-soft" href="#admission-form-section"
                                    data-course-select="arabic"><svg class="icon" aria-hidden="true">
                                        <use href="/assets/frontend/images/icons-sprite.svg#icon-clipboard-check">
                                        </use>
                                    </svg><span>ভর্তি আবেদন করুন</span></a>
                                <button class="btn btn-gold" type="button"
                    ...
                    <article class="card course-card-premium">
                        ...
                        <div class="card-body">
                            ...
                            <div class="course-actions">
                                <a class="btn btn-soft" href="#admission-form-section"
                                    data-course-select="tafsir"><svg class="icon" aria-hidden="true">
                                        <use href="/assets/frontend/images/icons-sprite.svg#icon-clipboard-check">
                                        </use>
                                    </svg><span>ভর্তি আবেদন করুন</span></a>
                                <button class="btn btn-gold" type="button"
                                    data-demo="কুরআন অনুবাদ ও তাফসির কোর্সের পেমেন্ট ডেমো চালু হয়েছে।"><svg
                                        class="icon" aria-hidden="true">
                                        <use href="/assets/frontend/images/icons-sprite.svg#icon-credit-card"></use>
                                    </svg><span>পেমেন্ট</span></button>
                            </div>
                    ...
                    <article class="card course-card-premium">
                        ...
                        <div class="card-body">
                            ...
                            <div class="course-actions">
                                <a class="btn btn-soft" href="#admission-form-section"
                                    data-course-select="hadith"><svg class="icon" aria-hidden="true">
                                        <use href="/assets/frontend/images/icons-sprite.svg#icon-clipboard-check">
                                        </use>
                                    </svg><span>ভর্তি আবেদন করুন</span></a>
                                <button class="btn btn-gold" type="button"
                    ...
                    <article class="card course-card-premium">
                        ...
                        <div class="card-body">
                            ...
                            <div class="course-actions">
                                ...
                                <button class="btn btn-gold" type="button"
                                    data-demo="ইসলামি আকিদা ও ফিকহ কোর্সের পেমেন্ট ডেমো চালু হয়েছে।"><svg
                                        class="icon" aria-hidden="true">
                                        <use href="/assets/frontend/images/icons-sprite.svg#icon-credit-card"></use>
                                    </svg><span>পেমেন্ট</span></button>
                            </div>
                    ...
                    <article class="card course-card-premium">
                        ...
                        <div class="card-body">
                            ...
                            <div class="course-actions">
                                <a class="btn btn-soft" href="#admission-form-section"
                                    data-course-select="maktab"><svg class="icon" aria-hidden="true">
                                        <use href="/assets/frontend/images/icons-sprite.svg#icon-clipboard-check">
                                        </use>
                                    </svg><span>ভর্তি আবেদন করুন</span></a>
                                <button class="btn btn-gold" type="button"
            ...
            <section id="training-section" class="service-page training-page reveal"
                ...
                <div class="service-hero training-hero">
                    <div class="service-copy">
                        ...
                        <div class="service-actions">
                            <a class="btn btn-gold" href="#admission-form-section"
                                data-course-select="teacher-training"><svg class="icon" aria-hidden="true">
                                    <use href="/assets/frontend/images/icons-sprite.svg#icon-clipboard-check"></use>
                ...
                <div class="maktab-hero">
                    <div class="maktab-copy">
                        ...
                        <div class="maktab-actions">
                            ...
                            <button class="btn btn-outline maktab-outline" type="button"
                                data-demo="মক্তব সিলেবাস ডেমো ডাউনলোড প্রস্তুত।"><svg class="icon"
                                    aria-hidden="true">
                    ...
                    <aside class="maktab-info-card" aria-label="মক্তব ফি, ব্যাচ, ক্লাস মোড ও মেয়াদ">
                        ...
                        <button class="btn btn-primary" type="button"
                            data-demo="মক্তব পেমেন্ট ডেমো চালু হয়েছে।"><svg class="icon" aria-hidden="true">
                                <use href="/assets/frontend/images/icons-sprite.svg#icon-credit-card"></use>
                            </svg><span>পেমেন্ট করুন</span></button>
                    </aside>
                </div>
                <div class="maktab-feature-grid">
                    <article class="card maktab-feature-card"><span class="maktab-feature-icon"
            ...
            <section id="digital-courses-section" class="section-panel reveal">
                ...
                <div class="grid grid-2 digital-grid">
                        ...
                        <div class="card-body">
                            ...
                            <div class="digital-footer">
                                <div class="digital-actions">
                                    <a class="btn btn-soft" href="#admission-form-section"
                                        data-course-select="digital"><svg class="icon" aria-hidden="true">
                                            <use href="/assets/frontend/images/icons-sprite.svg#icon-clipboard-check">
                                            </use>
                    ...
                    <article class="card digital-card">
                        <div class="digital-visual teal"><span class="badge blue">মধ্যবর্তী</span><span
                                class="play-button" aria-hidden="true"><svg class="icon">
                                    <use href="/assets/frontend/images/icons-sprite.svg#icon-play-circle"></use>
                                </svg></span></div>
                        <div class="card-body">
                            ...
                            <div class="digital-footer">
                                <div class="digital-actions">
                                    ...
                                    <button class="btn btn-gold" type="button"
                                        data-demo="অনলাইন আরবি ব্যাকরণ কোর্সের পেমেন্ট ডেমো চালু হয়েছে।"><svg
                                            class="icon" aria-hidden="true">
                                            <use href="/assets/frontend/images/icons-sprite.svg#icon-credit-card">
                                            </use>
                                        </svg><span>পেমেন্ট</span></button>
            ...
            <section id="admission-form-section" class="admission-split reveal">
                ...
                <form class="form-panel" id="admission-form" novalidate>
                    <div class="form-grid">
                        <div class="field"><label for="name">পূর্ণ নাম <span
                                    class="required">*</span></label><input class="input" type="text"
                                id="name" name="name" required placeholder="আপনার পূর্ণ নাম লিখুন"></div>
                        <div class="field"><label for="phone">মোবাইল নম্বর <span
                                    class="required">*</span></label><input class="input" type="tel"
                                id="phone" name="phone" required placeholder="০১XXXXXXXXX">
                        </div>
                        ...
                        <div class="field"><label for="branch">শাখা নির্বাচন <span
                                    class="required">*</span></label><select class="select" id="branch"
                        ...
                        <div class="field field-full"><label for="course">কোর্স নির্বাচন <span
                                    class="required">*</span></label><select class="select" id="course"
            ...
            <section id="muallim-application-section" class="muallim-application reveal"
                aria-labelledby="muallim-title">
                ...
                <form class="form-panel muallim-form" id="muallim-form" novalidate>
                    <div class="form-grid">
                        <div class="field"><label for="muallim-name">পূর্ণ নাম <span
                                    class="required">*</span></label><input class="input" type="text"
                                id="muallim-name" name="muallim-name" required placeholder="আপনার পূর্ণ নাম লিখুন">
                        </div>
                        <div class="field"><label for="muallim-phone">মোবাইল নম্বর <span
                                    class="required">*</span></label><input class="input" type="tel"
                                id="muallim-phone" name="muallim-phone" required placeholder="০১XXXXXXXXX">
                        </div>
                        <div class="field"><label for="muallim-email">ইমেইল</label><input class="input"
                                type="email" id="muallim-email" name="muallim-email" placeholder="আপনার ইমেইল">
                        </div>
                        <div class="field"><label for="muallim-district">জেলা <span
                                    class="required">*</span></label><input class="input" type="text"
                                id="muallim-district" name="muallim-district" required placeholder="আপনার জেলার নাম">
                        </div>
                        <div class="field"><label for="muallim-qualification">শিক্ষাগত যোগ্যতা <span
                                    class="required">*</span></label><select class="select"
                                id="muallim-qualification" name="muallim-qualification" required>
            ...
            <section id="video-gallery-section" class="section-panel reveal">
                <div class="section-head split-head">
                    ...
                    <a class="btn btn-soft" href="#digital-courses-section"><svg class="icon"
                            aria-hidden="true">
                            <use href="/assets/frontend/images/icons-sprite.svg#icon-play-circle"></use>
                ...
                <div class="video-grid">
                    ...
                    <button class="card video-card" type="button" data-video="তাজবিদ পাঠের নমুনা"
                        aria-label="তাজবিদ পাঠের নমুনা ভিডিও দেখুন"><span
                            class="video-thumb video-teal"></span><span class="video-play" aria-hidden="true"><svg
                                class="icon">
                                <use href="/assets/frontend/images/icons-sprite.svg#icon-play-circle"></use>
                    ...
                    <button class="card video-card" type="button" data-video="আরবি ব্যাকরণ পরিচিতি"
                        aria-label="আরবি ব্যাকরণ পরিচিতি ভিডিও দেখুন"><span
                            class="video-thumb video-amber"></span><span class="video-play"
                            aria-hidden="true"><svg class="icon">
                                <use href="/assets/frontend/images/icons-sprite.svg#icon-play-circle"></use>
                    ...
                    <button class="card video-card" type="button" data-video="শিক্ষক প্রশিক্ষণ হাইলাইটস"
                        aria-label="শিক্ষক প্রশিক্ষণ হাইলাইটস ভিডিও দেখুন"><span
                            class="video-thumb video-navy"></span><span class="video-play" aria-hidden="true"><svg
                                class="icon">
                                <use href="/assets/frontend/images/icons-sprite.svg#icon-play-circle"></use>
                    ...
                    <button class="card video-card" type="button" data-video="হিফজ শিক্ষার্থীর অগ্রগতি"
                        aria-label="হিফজ শিক্ষার্থীর অগ্রগতি ভিডিও দেখুন"><span
                            class="video-thumb video-teal"></span><span class="video-play" aria-hidden="true"><svg
                                class="icon">
                                <use href="/assets/frontend/images/icons-sprite.svg#icon-play-circle"></use>
                    ...
                    <article class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="book-footer"><span class="price">৳ ২৫০</span><button class="btn btn-soft"
                                    type="button"
                                    data-demo="আরবি ব্যাকরণ গাইড ক্রয়ের ডেমো অনুরোধ গ্রহণ করা হয়েছে।"><svg
                                        class="icon" aria-hidden="true">
                                        <use href="/assets/frontend/images/icons-sprite.svg#icon-book"></use>
                                    </svg><span>কিনুন</span></button></div>
                        </div>
                        ...
                        <table class="rep-table" aria-label="প্রতিনিধি তালিকা">
                            ...
                            <tbody id="representatives-table-body">
                                <tr data-district="dhaka" data-upozila="dhanmondi">
                                    ...
                                    <td data-label="ফোন"><a class="rep-phone" href="tel:01712345678"><svg
                                                class="icon" aria-hidden="true">
                                ...
                                <tr data-district="dhaka" data-upozila="gulshan">
                                    ...
                                    <td data-label="ফোন"><a class="rep-phone" href="tel:01812345678"><svg
                                                class="icon" aria-hidden="true">
                                                <use href="/assets/frontend/images/icons-sprite.svg#icon-phone"></use>
                                ...
                                <tr data-district="chittagong" data-upozila="banani">
                                    ...
                                    <td data-label="ফোন"><a class="rep-phone" href="tel:01912345678"><svg
                                                class="icon" aria-hidden="true">
                                                <use href="/assets/frontend/images/icons-sprite.svg#icon-phone"></use>
                                ...
                                <tr data-district="sylhet" data-upozila="amberkhana">
                                    ...
                                    <td data-label="ফোন"><a class="rep-phone" href="tel:01512345678"><svg
                                                class="icon" aria-hidden="true">
                                                <use href="/assets/frontend/images/icons-sprite.svg#icon-phone"></use>
            ...
            <section id="prayer-time-section" class="section-panel prayer-panel reveal">
                ...
                <div class="prayer-grid">
                    <div class="prayer-tile active"><span class="prayer-icon" aria-hidden="true"><svg
                                class="icon">
                                <use href="/assets/frontend/images/icons-sprite.svg#icon-clock"></use>
            ...
            <section id="quick-downloads-section" class="section-panel download-page reveal">
                ...
                <div class="downloads-grid"><a class="download-item" href="#"
                        data-demo="ভর্তি ফর্ম ডাউনলোডের ডেমো চালু হয়েছে।"><span class="download-icon"
                            ...
                            </svg></span><span><span class="download-title">ভর্তি ফর্ম</span><span
                                class="download-size">PDF • ৫০০
                                KB</span></span><span class="download-arrow" aria-hidden="true"><svg
                                class="icon">
                                <use href="/assets/frontend/images/icons-sprite.svg#icon-download"></use>
                        ...
                        data-demo="কোর্স ব্রোশার ডাউনলোডের ডেমো চালু হয়েছে।"><span class="download-icon"
                            aria-hidden="true"><svg class="icon">
                                ...
                                MB</span></span><span class="download-arrow" aria-hidden="true"><svg
                                class="icon">
                                <use href="/assets/frontend/images/icons-sprite.svg#icon-download"></use>
                            </svg></span></a><a class="download-item" href="#"
                        ...
                        data-demo="শিক্ষা ক্যালেন্ডার ডাউনলোডের ডেমো চালু হয়েছে।"><span class="download-icon"
                            aria-hidden="true"><svg class="icon">
                                ...
                                ৩০০ KB</span></span><span class="download-arrow" aria-hidden="true"><svg
                                class="icon">
                                <use href="/assets/frontend/images/icons-sprite.svg#icon-download"></use>
                            </svg></span></a><a class="download-item" href="#"
                        ...
                        data-demo="সিলেবাস ডাউনলোডের ডেমো চালু হয়েছে।"><span class="download-icon"
                            aria-hidden="true"><svg class="icon">
                                <use href="/assets/frontend/images/icons-sprite.svg#icon-file-text"></use>
                            </svg></span><span><span class="download-title">সিলেবাস</span><span
                                class="download-size">PDF • ৮০০
                                KB</span></span><span class="download-arrow" aria-hidden="true"><svg
                                class="icon">
                                <use href="/assets/frontend/images/icons-sprite.svg#icon-download"></use>
                            </svg></span></a></div>
            ...
            <section id="results-section" class="service-page results-page reveal"
                ...
                <div class="result-layout">
                    <form id="result-lookup-form" class="form-panel result-lookup-card" novalidate>
                        <div class="form-grid">
                            <div class="field"><label for="result-student-id">শিক্ষার্থী আইডি <span
                                        class="required">*</span></label><input class="input"
                                    id="result-student-id" type="text" required
                                    placeholder="যেমন: IE-2024-102"></div>
                        ...
                        <button class="btn btn-primary" type="submit" style="margin-top:16px"><svg
                                class="icon" aria-hidden="true">
                    ...
                    <aside class="result-preview-card" aria-label="ডেমো ফলাফল">
                        ...
                        <button class="btn btn-soft" type="button"
                            data-demo="ডেমো ফলাফল PDF ডাউনলোড প্রস্তুত।"><svg class="icon" aria-hidden="true">
                                <use href="/assets/frontend/images/icons-sprite.svg#icon-download"></use>
            ...
            <section id="exam-section" class="service-page exam-page reveal" aria-labelledby="exam-title">
                <div class="section-head split-head">
                    ...
                    <button class="btn btn-soft" type="button"
                        data-demo="প্রবেশপত্র ডাউনলোডের ডেমো চালু হয়েছে।"><svg class="icon" aria-hidden="true">
                            <use href="/assets/frontend/images/icons-sprite.svg#icon-file-text"></use>
                ...
                <div class="exam-grid">
                    ...
                    <article class="card exam-card"><span
                            class="exam-date"><strong>২২</strong><small>মার্চ</small></span>
                        <div>
                    ...
                    <article class="card exam-card"><span
                            class="exam-date"><strong>২৯</strong><small>মার্চ</small></span>
                        <div>
            ...
            <section id="calendar-section" class="section-panel calendar-page reveal"
                ...
                <div class="section-head split-head">
                    ...
                    <button class="btn btn-soft" type="button"
                        data-demo="শিক্ষা ক্যালেন্ডার ডাউনলোডের ডেমো চালু হয়েছে।"><svg class="icon"
                            aria-hidden="true">
                            <use href="/assets/frontend/images/icons-sprite.svg#icon-download"></use>
            ...
            <section id="student-login-section" class="student-access-section reveal"
                ...
                <form id="sidebar-login-form" class="student-login-card" novalidate>
                    ...
                    <input class="input" id="student-id" type="text" required
                        placeholder="আইডি / ব্যবহারকারীর নাম">
                    <label class="visually-hidden" for="student-password">পাসওয়ার্ড</label>
                    <input class="input" id="student-password" type="password" required
            ...
            <section id="donation-section" class="donation-band donation-premium reveal"
                ...
                <div class="donation-copy">
                    ...
                    <div class="donation-actions">
                        <button class="btn btn-gold donation-primary-cta" type="button"
                            data-demo="দান করার ডেমো অনুরোধ গ্রহণ করা হয়েছে।"><svg class="icon"
                                aria-hidden="true">
                                <use href="/assets/frontend/images/icons-sprite.svg#icon-heart"></use>
                            </svg><span>এখনই দান করুন</span></button>
                        <a class="btn btn-outline" href="#contact-us-section"><svg class="icon"
                                aria-hidden="true">
                                <use href="/assets/frontend/images/icons-sprite.svg#icon-phone"></use>
