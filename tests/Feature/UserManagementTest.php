...
class UserManagementTest extends TestCase
{
    ...
    public function test_user_profile_and_additional_images_save_paths_and_track_media(): void
    {
        ...
        $folder = MediaFolder::query()->create([
            'name' => 'User Images',
            'saved_name_into_storage' => 'user-images',
            'parent_id' => 0,
            'status' => 1,
        ]);
        $profile = Media::query()->create([
            'disk' => 'ftp',
            'path' => 'users/profile-images/profile.jpg',
        ...
        $firstAdditional = Media::query()->create([
            'disk' => 'ftp',
            'path' => 'users/additional-images/classroom.jpg',
        ...
        $secondAdditional = Media::query()->create([
            'disk' => 'ftp',
            'path' => 'users/additional-images/certificate.jpg',
            'filename' => 'certificate.jpg',
            'extension' => 'jpg',
            'mime_type' => 'image/jpeg',
            'size' => 100,
        ...
        $response = $this->actingAs($admin)->postJson(route('backend.users.store'), [
            ...
            'phone' => '01700000002',
            'profile_image_url' => 'https://posftp.bme.com.bd/users/profile-images/profile.jpg',
            'profile_image_path' => 'users/profile-images/profile.jpg',
            'additional_image_urls' => json_encode([
                'https://posftp.bme.com.bd/users/additional-images/classroom.jpg',
                'https://posftp.bme.com.bd/users/additional-images/certificate.jpg',
            ]),
            'additional_image_paths' => json_encode([
                'users/additional-images/classroom.jpg',
                'users/additional-images/certificate.jpg',
            ]),
            'user_type_id' => $type->id,
            'status' => 1,
            'password' => 'password123',
        ...
        $response->assertCreated();
        $user = User::query()->where('email', 'image-user@example.com')->firstOrFail();

        $this->assertSame('users/profile-images/profile.jpg', $user->profile_image_path);
        $this->assertSame([
            'users/additional-images/classroom.jpg',
            'users/additional-images/certificate.jpg',
        ], $user->additional_image_paths);
        $this->assertDatabaseHas('media_in_uses', [
            'media_id' => $profile->id,
            'model' => User::class,
            'model_id' => $user->id,
        ...
        $this->assertDatabaseHas('media_in_uses', [
            'media_id' => $firstAdditional->id,
            'model' => User::class,
            'model_id' => $user->id,
            'col_name' => 'additional_image_paths',
        ]);
        $this->assertDatabaseHas('media_in_uses', [
            'media_id' => $secondAdditional->id,
            'model' => User::class,
            'model_id' => $user->id,
            'col_name' => 'additional_image_paths',
        ]);
